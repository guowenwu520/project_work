...
def fail(message):
 raise SystemExit("[48-scene view-label coverage failed] "+message)
...
print("\n[48-scene view-label coverage validation passed]")
for change_type in types:
 print(f"  {change_type}: 60/60 covered; 56 once, 4 twice")
print("  left/right labels: strict 1st-view / 2nd-view format passed")
